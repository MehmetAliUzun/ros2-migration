...
def generate_launch_description():
    ...
    joint_controllers_file = os.path.join(
        get_package_share_directory('ur5e_leitungssatz_sim'), 'config', 'ur5e_controllers.yaml'
    )
    ...
    moveit_config = (
        MoveItConfigsBuilder("custom_robot", package_name="ur5e_leitungssatz_moveit_config")
    ...
    rviz_config_path = os.path.join(
        get_package_share_directory("ur5e_leitungssatz_moveit_config"),
        "config",
        "moveit.rviz",
    )
